...
set "SCRIPT=%~dp0crimson_desert_save_guardian_safe_v7.py"
set "DIST=%~dp0"
set "WORK=%~dp0_build_safe_v7"
set "SPEC=%~dp0_spec_safe_v7"
set "NAME=CrimsonDesertSaveGuardian_SAFE_v7"
...
echo.
echo Gerando EXE SAFE V7...
python -m PyInstaller --noconfirm --onefile --windowed --name="%NAME%" --distpath="%DIST%" --workpath="%WORK%" --specpath="%SPEC%" "%SCRIPT%"
